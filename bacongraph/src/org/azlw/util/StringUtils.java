...
public enum StringUtils {
	...
	public static String join(final String delimiter, final Iterable<? extends String> elements) {
		...
		final String d = (Strings.isBlankString(delimiter)) ? "" : delimiter;
		final Iterator<? extends String> it = elements.iterator();
	...
	public static String join(final String delimiter, final String... elements) {
		// signature also valide for join(String, String[])
	...
	public static String toUpperCase(final Object source) {
		return StringUtils.getString(source).toUpperCase();
	}


	public static boolean isEmptyStringCollection(final Collection<String> collection) {
	...
	public static boolean hasIntersectionString(final Collection<String> col0, final Collection<String> col1) {
		if ((null == col0) || (null == col1)) { return false; }
		if (col0.isEmpty() || col1.isEmpty()) { return false; }

		for (final String s : col0) {
			if (col1.contains(s)) { return true; }
		}
		for (final String s : col1) {
			if (col0.contains(s)) { return true; }
		}
